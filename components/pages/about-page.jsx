    ...
    <section className="studio-page about-page">
      ...
      <section className="page-grid about-profile" aria-label="Profile">
        <div>
          <h2>What I do</h2>
          <p>
            I am Daniel, a Business Intelligence specialist with experience across finance, infrastructure, and
        ...
        <div className="about-profile-side">
          <figure className="about-portrait" aria-label="Stylised portrait of Daniel">
            <img src="/about-portrait.jpg" alt="Stylised portrait of Daniel in a surreal illustrated landscape" />
