...
- Since 24 September 2026 (Dan's redesign request) the page is one sheet of paper with five things — taste, features, websites, career and trek — that open in place as rooms with their own hash and history entry; the trek opens `/trek/`. Taste, Career and the website cards are the previous homepage's components, restyled, not replacements: Dan asked to build on what was there. The panda mascot was rejected; the site has no character besides the Akibwa `a`.
- Dan asked on 24 September 2026 for his top 1,000 songs and top 100 artists. `public/music-ranking.json` publishes only rank, title, artist, plays and the YouTube share, built by `scripts/build-music-ranking.mjs` from the private history's prepared ranking; dates, listening time, track URIs and account detail never leave the private history.
- Websites lists the three sites Dan chose on 24 September 2026: Português com a Inês, Castle Bank and Butterfly Rose. Castle Bank's home page names and pictures its founders, Dan included; its card capture hides them, and nothing on akibwa.com may name Dan in full. Butterfly Rose is in review with the salon: show its review-build screenshot without a link until Dan's build is live on its domain.
