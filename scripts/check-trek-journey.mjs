...
import './check-trek-continuous.mjs';
...
assert.deepEqual(runtimeAssets.map(a=>a[1]).sort(),['journey-cache.js','journey-camera.js','journey-elevation.js','journey-landmarks.js','journey-metrics.js','journey-pace.js','journey-paper-ui.css','journey-paper.js','journey-prepared.js','journey-route.js','journey-tally.js','journey-train.js','journey-traveller.css','journey-traveller.js','journey-wayfinding.js'],'the generated page references the complete traveller runtime');
